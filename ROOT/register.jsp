            ...
            <form name="register" ng-submit="postCtrl.postForm()" method="POST">
                ...
                <div class="from-group">
                    ...
                    <span style="color:red" ng-show="register.password.$invalid">
                        <span ng-show="register.password.$error.required">** Se requiere contraseña.</span>
                    </span>
                </div>
                ...
                <span style="color:red" ng-show="register.confirmpassword.$invalid">
                    <span ng-show="register.confirmpassword.$error.compareTo">** Contraseña que no coincide.</span>
                </span>
                ...
                <span style="color:red" ng-show="register.emailid.$invalid">
                    <span ng-show="register.emailid.$error.required">** Se requiere correo electrónico.</span>
                    <span ng-show="register.emailid.$error.email">** ID de correo electrónico no válido.</span>
                </span>
